...
describe("Header", () => {
	...
	it("tema escuro pode ser alternado", async () => {
		...
		// Verifica se o botão foi clicado e o estado foi alterado
	...
	it("menu mobile pode ser aberto e fechado", async () => {
		...
		// Em viewports mobile, a navegação deve estar escondida inicialmente
		expect(screen.queryByRole("navigation")).not.toBeVisible();

		const menuButton = screen.getByRole("button", { name: /menu/i });
		await user.click(menuButton);

		// Após clicar, a navegação deve estar visível
